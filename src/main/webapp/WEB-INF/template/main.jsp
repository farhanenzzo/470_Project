        ...
        <c:if test="${pageContext.request.userPrincipal.name != null}">
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    <a class="nav-link active" aria-current="page" href="/auth/dashboard">Dashboard</a>
                    <a class="nav-link active" aria-current="page" href="/analytics/show">Analytics</a>
                </div>
            </div>
...
<nav class="navbar fixed-bottom navbar-light" style="background-color: #e3f2fd;">
    <div class="container-fluid" style="padding-left: 40%">
        <div style="padding-top: 15px; text-align: center; font-size: 14px">
            <p>© Team Akatsuki. All Rights Reserved</p>
        </div>
    </div>
</nav>
